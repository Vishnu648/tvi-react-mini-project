    ...
    <div>
      ...
      <section className="flex">
        <nav className="bg-[#212529] w-[272px] h-screen">
          ...
          <Link to='/' className="w-full flex items-center gap-2 h-[48px] px-4 py-3 text-[#686b6d] cursor-pointer text-[1rem] font-normal ">
        ...
        <section className="px-6 w-full">
          ...
          <div className="bg-[#e9ecef] w-full h-12 flex items-center text-[#838b92] px-4 rounded-sm text-[1rem] mb-6">
            Dashboard
          </div>
          <AdminTable />
        </section>
